...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "django-insecure-f(+0z=ye)&$cg(b8+q1eqpw*0^89$#ch9*c5ysw=gvbkk-ww94"
)
...
CORS_ALLOWED_ORIGINS = [
    ...
    for origin in os.environ.get(
        "CORS_ALLOWED_ORIGINS", "http://localhost:5173,https://grocery-bud-restapi.vercel.app"
    ).split(",")
    if origin.strip()
]
